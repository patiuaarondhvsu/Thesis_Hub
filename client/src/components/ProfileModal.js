...
const ProfileModal = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      const fetchUserData = async () => {
        try {
          const response = await axios.get('https://thesis-hub-server.onrender.com/profile', { withCredentials: true });
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios.post('https://thesis-hub-server.onrender.com/profile/edit', data, {
