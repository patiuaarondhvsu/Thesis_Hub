...
const ThesesPage = () => {
    ...
    const confirmDelete = () => {
        axios.delete(`https://thesis-hub-server.onrender.com/api/thesis/${thesisToDelete}`)
            .then(() => {
                                ...
                                <form
                                    onSubmit={async (e) => {
                                        ...
                                        try {
                                            ...
                                            await axios.put(`https://thesis-hub-server.onrender.com/api/thesis/${selectedThesis._id}`, updatedThesis);
